...
// The Privacy component displays the privacy and legal information for the website
const Privacy = () => {
  return (
    // Container for all privacy and legal information
    <div className="privacy-legal">
      ...
      <p><a className="fancy-link" href="http://www.google.co.uk/intl/en/analytics/privacyoverview.html" target="_blank" rel="noopener noreferrer">Click here for an overview of privacy at Google</a></p>
      <p>To opt out of being tracked by Google Analytics across all websites visit <a className="fancy-link" target="_blank" rel="noopener noreferrer" href="http://tools.google.com/dlpage/gaoptout">http://tools.google.com/dlpage/gaoptout</a>.</p>
      <p>By law web browsers allow control of cookie usage through the browser settings. To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit <a className="fancy-link" href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" >http://www.allaboutcookies.org</a>
      </p>
...
export default Privacy;  // Export the component for use in other parts of the app